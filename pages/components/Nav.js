...
const Nav = ()=>{
   return(
    ...
    <Image className="sm:translate-x-6 rounded-lg" alt="Logo" priority width={137} height={57} src="/100.png" />
    </div>
    ...
    <Link href="https://threads.net/100daysofnextjs" className="text-xs font-medium px-4 py-2.5 rounded-full hover:opacity-100 hover:shadow-sm bg-[#127CE5] text-white flex gap-1">
